        ...
        <div className="min-h-screen flex bg-gray-50">
            ...
            <div className="hidden lg:block w-[55%] relative m-5 rounded-3xl overflow-hidden shrink-0">
                ...
                <div className="relative z-10 h-full flex flex-col justify-between p-12">
                    ...
                    >
                        <div className="w-10 h-10 rounded-full bg-white/25 backdrop-blur flex items-center justify-center overflow-hidden">
            ...
            <div className="flex-1 flex items-center justify-center bg-white px-6 py-10">
                ...
                >
                    ...
                    >
                        ...
                        <span className="font-bold text-xl text-gray-900 tracking-tight">TRUVA</span>
                        <span className="text-gray-400 text-xs tracking-widest uppercase mt-1">Modern Banking</span>
                    </motion.div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        >
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full pl-11 pr-4 py-3.5 rounded-xl border border-gray-200 bg-gray-50 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:border-[#00c6ff] focus:ring-2 focus:ring-[#00c6ff]/20 transition-all duration-200"
                                />
                            </div>
                        </motion.div>
                        ...
                        >
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full pl-11 pr-11 py-3.5 rounded-xl border border-gray-200 bg-gray-50 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:border-[#00c6ff] focus:ring-2 focus:ring-[#00c6ff]/20 transition-all duration-200"
                                />
                                <button
                                    type="button"
                        ...
                        >
                            <motion.button
                                ...
                                whileTap={{ scale: 0.97 }}
                                className="w-full py-3.5 rounded-xl bg-linear-to-r from-[#00c6ff] to-[#7b2ff7] text-white cursor-pointer text-sm font-semibold tracking-wide shadow-lg shadow-[#7b2ff7]/25 hover:opacity-90 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed mt-1"
                            >
                                {loading ? (
